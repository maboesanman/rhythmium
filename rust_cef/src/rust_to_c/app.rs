...
use cef_wrapper::cef_capi_sys::{
    cef_app_t, cef_base_ref_counted_t, cef_command_line_t, cef_string_t,
};
...
pub trait AppConfig: Sized + Send + Sync {
    ...
    // fn get_browser_process_handler(&self, browser_process_state: &Self::BrowserProcessState) -> Option<()> {
    //     None
    // }
