    ...
    K: Ord,
{
    ...
    match entry {
        Entry::Occupied(entry) => Ok(OccupiedExtEntry { btree_map, entry }),
        Entry::Vacant(entry) => Err(VacantExtEntry { btree_map, entry }),
    }
}
...
pub fn get_first_occupied_mut<K: Ord, V>(
    ...
    let entry = OccupiedExtEntry { btree_map, entry };
...
impl<'a, K: Ord, V> OccupiedExtEntry<'a, K, V> {
    ...
    pub fn vacate(self) -> (VacantExtEntry<'a, K, V>, V) {
        ...
        let new_entry = VacantExtEntry { btree_map, entry };
...
impl<'a, K: Ord, V> VacantExtEntry<'a, K, V> {
        ...
        K: Clone,
    {
        ...
        OccupiedExtEntry { btree_map, entry }
    }
