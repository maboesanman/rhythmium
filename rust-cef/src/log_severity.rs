use cef_sys::{
    cef_log_severity_t,
    cef_log_severity_t_LOGSEVERITY_DEFAULT,
    cef_log_severity_t_LOGSEVERITY_DEBUG,
    cef_log_severity_t_LOGSEVERITY_INFO,
    cef_log_severity_t_LOGSEVERITY_WARNING,
    cef_log_severity_t_LOGSEVERITY_ERROR,
    cef_log_severity_t_LOGSEVERITY_FATAL,
    cef_log_severity_t_LOGSEVERITY_DISABLE,
};

fn _assert_c_uint_equals_u32(v: cef_log_severity_t) -> u32 { v }
